...
class IntegratedModel:
    def __init__(self, keras_model, input_scaler, output_scaler, temp_file=None, offset=None, log_preprocess=False, zero_columns=None, rescaling_factor=None, pca=None, pca_scaler=None):
    ...
    def restore(self, filename):
        ...
        self.model = load_model(filename + "_model.h5", custom_objects={'CustomLoss': CustomLoss, 'CustomActivation': CustomActivation}, compile=False)
